...
export default function HomeScreen() {
  ...
  const { data, goals, percentages, addMeal, addWater, addSteps } = useAppData();
    ...
    <ScreenContainer>
      ...
      <AppCard style={styles.progressCard}>
        ...
        <View style={styles.progressLineWrap}>
          <View style={[styles.progressLine, { backgroundColor: colors.border }]}>
            <View
              style={[
                styles.progressFill,
                { backgroundColor: colors.primary, width: `${data.progress}%` },
              ]}
            />
          </View>
        </View>
        ...
        <View style={styles.progressStats}>
          <View>
            <Text style={[styles.bigSmall, { color: colors.primary }]}>
              {data.progress}%
            </Text>
        ...
        <AppCard style={styles.gridCard}>
          ...
          <View style={[styles.metricBar, { backgroundColor: colors.border }]}>
            <View
              style={[
                styles.metricFill,
                { width: `${percentages.steps}%`, backgroundColor: colors.success },
              ]}
            />
          </View>
      ...
      <View style={styles.testRow}>
        <Pressable
          onPress={() => addMeal({ calories: 250, protein: 20, carbs: 30, fat: 8 })}
          style={[styles.testButton, { backgroundColor: colors.primary }]}
        >
          <Text style={styles.testButtonText}>Add Meal</Text>
        </Pressable>
